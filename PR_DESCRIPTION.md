...
The latest observed remote check state was mixed and may already have moved:
static analysis, CodeQL analysis, frontend unit, dependency/license audit, and
Postgres testcontainer checks had green runs; Playwright E2E and the telemetry
backfill trailer check had failing runs; Python 3.12/3.13 tests were still in
progress in the viewed snapshot. Re-check GitHub before treating this PR as
merge-ready.
