...
**Sibling plans:**
- Predecessor: [15a1-phase-3a-removals-part-1.md](15a1-phase-3a-removals-part-1.md) / [15a2-phase-3a-removals-part-2.md](15a2-phase-3a-removals-part-2.md) — Phase 3B **assumes 15a has shipped**. The `SideRail.tsx` scaffold, `HeaderSessionSwitcher`, `InlineRunResults`, the deletions of `SpecView` / `RunsView` / `SessionSidebar`, and the auto-validate effect are all preconditions. If 15a is mid-stream, do not start 15b — finish 15a first.
