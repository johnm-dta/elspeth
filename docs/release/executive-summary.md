...
> This document is the executive-tier briefing for ELSPETH, written for senior officials in the Australian public sector evaluating the platform for high-assurance pipeline work. It is linked as a draft because it was written for a specific audience; the operator is reviewing claims about assurance status, compliance posture, and residual risk before publication. Comments and corrections welcome.
