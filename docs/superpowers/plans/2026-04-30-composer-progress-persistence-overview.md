...
**Spec:** `docs/superpowers/specs/2026-04-30-composer-progress-persistence-design.md` (revision 4, 2481 lines). The Phase 1 plan contains reviewed corrections that supersede several stale spec snippets; Phase 1 must either amend the spec in-repo or mark those sections explicitly superseded before Phase 2 or Phase 3 begins.
