...
```bash
git clone https://github.com/your-org/elspeth-rapid.git && cd elspeth-rapid
...
- [docs/contracts/plugin-protocol.md](docs/contracts/plugin-protocol.md) - Protocol specification
- [CLAUDE.md](CLAUDE.md) - Three-Tier Trust Model
- [TEST_SYSTEM.md](TEST_SYSTEM.md) - Test system documentation
