...
**Context:** Three skill-text gaps were closed today on RC5.1 (commit `906c6332`, see `notes/composer-skill-gaps-2026-05-09.md`). The skill edits eliminated silent shape downgrade and improved source-binding correctness, but two failure modes remain that look exactly like what the big-brother feature was added for.
