...
**Status: COMPLETE.** Working artefacts at `notes/eval-evidence/2026-05-03-composer/hardmode/`.
...
- `notes/eval-evidence/2026-05-03-composer/hardmode/personas/` — 3 persona specs (markdown)
- `notes/eval-evidence/2026-05-03-composer/hardmode/scenarios/` — 9 scenario fixtures (json)
- `notes/eval-evidence/2026-05-03-composer/hardmode/results/{p?_t?_*}/` — per-scenario session, blob, message bodies, response JSON, validate, execute, run, diagnostics, ledger
- `notes/eval-evidence/2026-05-03-composer/hardmode/aggregate.json` — cross-scenario summary
- `notes/eval-evidence/2026-05-03-composer/hardmode/{harness,post_message,finalize_scenario}.sh` — harness driver scripts
...
- `notes/eval-evidence/2026-05-03-composer/hardmode/results/p1_t1_happy/turn4.user.txt` — operator's model-swap message
