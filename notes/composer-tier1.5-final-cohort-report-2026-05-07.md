...
**Supersedes:** `notes/composer-tier1.5-cohort-report-2026-05-06.md`
...
Prior cohort's 1/15 PARTIAL was the SharePoint honest-refusal probe (`p1_t3_limit_sharepoint`) — appropriate refusal-with-alternative behaviour, not pipeline-construction hedging. See `notes/composer-multi-turn-demo-readiness-2026-05-07.md` for the full analysis. In pipeline-construction context: 0/14 prior valid samples + 0/30+ this session = effectively 0% hedging risk.
