...
ENTRIES = [
    ...
    # --- csv_source.py ---
    (
        "plugins/sources/csv_source.py",
        "R6",
        "CSVSource._load_from_file",
        "fp=054e76166ade23bc",
    ...
    (
        ...
        "R1",
        "DataverseSource._normalize_row_fields",
        "fp=b9db16c1b599becb",
    ...
    # --- manager.py ---
    (
        "plugins/infrastructure/manager.py",
        "R4",
    ...
    # --- batching/mixin.py ---
    (
        "plugins/infrastructure/batching/mixin.py",
        "R9",
        "BatchTransformMixin._release_loop",
        "fp=2f93bd40222e5b89",
    ...
    # --- http.py ---
    (
        "plugins/infrastructure/clients/http.py",
        "R1",
        "AuditedHTTPClient._parse_response_body",
        "fp=c10e1a372d3013e8",
    ...
    (
        ...
        "R1",
        "_extract_usage_from_provider_response",
        "fp=153b600f7b824428",
    ...
    # --- rag/transform.py ---
    (
        "plugins/transforms/rag/transform.py",
        "R2",
        "RAGRetrievalTransform._configured_collection_name",
        "fp=757eb1e99aea1a3e",
    ...
    # --- web_scrape.py ---
    (
        "plugins/transforms/web_scrape.py",
        "R5",
        "WebScrapeTransform.get_post_call_hints",
        "fp=f919002b3beb8525",
    ...
    (
        ...
        "R6",
        "DatabaseSink._insert_with_per_row_diversion",
        "fp=9e9d1f67fecbd6f2",
    ...
    # --- csv_sink.py ---
    (
        "plugins/sinks/csv_sink.py",
        "R6",
        "CSVSink._stage_rows_per_row",
        "fp=73ebd4f4b271eb4f",
    ...
    (
        "plugins/sources/azure_blob_source.py",
        "R6",
        "AzureBlobSource._load_csv",
        "fp=e59ce88529f38df2",
