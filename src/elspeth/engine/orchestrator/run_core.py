...
class RunExecutionCore:
    ...
    def build_processor(
        ...
        *,
        ...
        follower), forwarding this core's stored seams and defaulting
        ``mode=ProcessorMode.LEADER``. The name and signature are load-bearing
        for the main/resume call sites and test patches.
...
def build_row_processor(
    *,
    ...
    the resume path call it through :meth:`RunExecutionCore.build_processor`
