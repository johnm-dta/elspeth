...
1. Read `tests/audit/CHUNKS.md` (this file) for the chunk plan and progress.
2. Read `tests/audit/README.md` for the cross-chunk patterns and methodology.
3. Read the most recent `tests/audit/<chunk>-findings.md` for the immediate context.
...
6. Synthesise into `tests/audit/<chunk>-findings.md` and `tests/audit/<chunk>-raw-reports.md`.
