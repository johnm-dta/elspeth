...
def test_blob_inline_resolutions_schema_epoch_is_12(engine) -> None:
    assert SESSION_SCHEMA_EPOCH == 12
    with engine.connect() as conn:
        assert conn.execute(text("PRAGMA user_version")).scalar_one() == 12
