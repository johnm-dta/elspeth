...
def test_blob_inline_resolutions_schema_epoch_is_27(engine) -> None:
    assert SESSION_SCHEMA_EPOCH == 27
    with engine.connect() as conn:
        assert conn.execute(text("PRAGMA user_version")).scalar_one() == 27
