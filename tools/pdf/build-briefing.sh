...
# ─────────────────────────────────────────────────────────────
DEFAULT_SOURCE="$PROJECT_ROOT/notes/composer-evaluation-briefing-2026-05-03.md"
DEFAULT_METADATA="$SCRIPT_DIR/briefing-metadata.yaml"
DEFAULT_OUTPUT="$PROJECT_ROOT/docs/assets/composer-evaluation-briefing-2026-05-03.pdf"
